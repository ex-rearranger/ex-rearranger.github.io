...
class LocalSearch {
  ...
  getResultItems (keywords) {
    ...
    this.datas.forEach(({ title, language, tags, categories, content, url }) => {
      ...
      resultItem += '<div style="font-size: 0.9em; font-weight: 500; color:#999; margin: 3px 0;">'
      ...
      slicesOfContent.forEach(slice => {
        resultItem += `<p class="search-result" style="font-size:0.95em; line-height: 1.5; word-break: break-all;">${this.highlightKeyword(content, slice)}...</p></a>`
      })
